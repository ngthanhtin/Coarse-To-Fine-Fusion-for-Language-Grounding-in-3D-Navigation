import vizdoom
import argparse
import multigoal_env as multigoal_grounding_env
import numpy as np
import cv2
...
parser.add_argument('--all-instr-file', type=str,
                    default="data/multigoal_instruction/multigoal_instructions_all.json",
                    help="""All instructions file
                    (default: data/multigoal_instruction/multigoal_instructions_all.json)""")
parser.add_argument('--train-instr-file', type=str,
                    default="data/multigoal_instruction/multigoal_instructions_train.json",
                    help="""Train instructions file
                    (default: data/multigoal_instruction/multigoal_instructions_train.json)""")
parser.add_argument('--test-instr-file', type=str,
                    default="data/multigoal_instruction/multigoal_instructions_test.json",
...
if __name__ == '__main__':
    ...
    env = multigoal_grounding_env.MultiGoal_GroundingEnv(args)
    env.game_init()
